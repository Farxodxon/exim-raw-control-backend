...
|---|---|---|
| `tool/e2e_flow.dart` | 190 | To'liq oqim: mahsulot → ombor → transfer → ishlab chiqarish → karantin → dillerlar → transfer avtomanzillari → davomat GPS/audit/unmarked |
...
5. **Davomat:** `hours_worked` — tushlik (12:00–14:00) ish vaqtidan chiqariladi: to'liq kun = 08:00–12:00 (4 soat) + 14:00–18:00 (4 soat) = **8 soat**; 8 soat mehnat normasi bilan chegaralanadi; tun smenada +1440 min. `overtime_hours` faqat qo'lda kiritiladi.
...
| 2026-09-06 | `95c697d` | **Davomat overtime:** attendance.overtime_hours (manual), ish vaqti tushlik (12:00–14:00) chiqarilgan holda 8 soatgacha, monthly total_overtime_hours |
